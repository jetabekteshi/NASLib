...
class PredictorConfigSpace:
    ...
    def build_config_space(self):
        ...
        if self.predictor_type == 'XGB':
            ...
            beta_dngo = UniformIntegerHyperparameter('beta_dngo', 1e-5, 1e5, default_value=100)
            do_mcmc_dngo = CategoricalHyperparameter('do_mcmc_dngo', [True, False], default_value=False)
            n_hypers_dngo = UniformIntegerHyperparameter('n_hypers_dngo', 1, 50, default_value=20)
            ...
            lr_lgb = UniformFloatHyperparameter('lr_lgb', 0.00001, 0.1, default_value=0.5, log=True)
            ...
            lr_gcn = UniformFloatHyperparameter('lr_gcn', 0.1, 0.00001, default_value=0.0001, log=True)
            ...
            # Var Sparse GP
            kernel_vs_gp = CategoricalHyperparameter('kernel_vs_gp', ['RBF', 'Matern32', 'Matern52'],
                                                     default_value='RBF')
